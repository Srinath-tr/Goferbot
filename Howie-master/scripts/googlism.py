...
def main():
	...
	try:
                for q in qn:
                        if q in query:
                                query_wiki = query[len(q):]
                                #print query_wiki
                                wiki(query_wiki)
                                #print (wikipedia.summary(query_wiki)).encode('ascii', 'ignore')
                                #p=wikipedia.page(query_wiki)
                                #print p.title
                                #content = p.content
                                #print content
                                #fstop = content.find('.')
                                #response = content[:fstop]
